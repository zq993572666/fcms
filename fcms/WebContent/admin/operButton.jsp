...
<div id="man_zone" >
  ...
  <b> 顺序</b>
   ...
   <tr>
    ...
    <input type="text"  id="name" name="name" size="8" MAXLENGTH="50" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
      </td>
      <td >
    ...
    <input type="text" value="<%=operbutton.getName() %>" size="8" id="name<%=operbutton.getId() %>" name="name<%=operbutton.getId() %>" MAXLENGTH="50" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
      </td>
      <td >
     <input type="radio"  id="isok<%=operbutton.getId() %>1" name="isok<%=operbutton.getId() %>" value="1" checked="checked"/>是
     <input type="radio" id="isok<%=operbutton.getId() %>0" name="isok<%=operbutton.getId() %>"  value="0" <%=(!"1".equals(operbutton.getIsok()))?"checked":"" %>/>否
      </td>
      <td >
    ...
    <input type="text" size="40" value="<%=operbutton.getCode()!=null?operbutton.getCode():"" %>" id="code<%=operbutton.getId() %>" name="code<%=operbutton.getId() %>" MAXLENGTH="500" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
      ...
      <td >
    <input type="button" value="修改" onclick="updateOperbutton('<%=operbutton.getId() %>')" class="button">
